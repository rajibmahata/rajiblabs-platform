  ...
  return (
    <section id="contact" className="max-w-7xl mx-auto px-6 pb-24">
      <div className="text-center mb-14">
        <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-[var(--text-muted)] mb-4">Contact & Collaboration</h2>
        <p className="text-3xl md:text-4xl font-bold text-white mb-4">Let's build together</p>
        <p className="text-[var(--text-secondary)] max-w-xl mx-auto">
          Open to AI projects, enterprise architecture consulting, and product development collaborations.
        </p>
      </div>

      <div className="max-w-2xl mx-auto grid sm:grid-cols-3 gap-4 animate-fade-up">
        <a href="https://github.com/rajibmahata" target="_blank" rel="noopener noreferrer"
          ...
          <p className="text-xs text-[var(--text-muted)]">github.com/rajibmahata</p>
        </a>
        ...
        <a href="https://linkedin.com/in/rajib-mahata" target="_blank" rel="noopener noreferrer"
          ...
          <p className="text-xs text-[var(--text-muted)]">linkedin.com/in/rajib-mahata</p>
        </a>

        <a href="mailto:contact@rajiblabs.com"
          className="glass-card p-6 text-center group">
          <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center mx-auto mb-3 group-hover:bg-white/10 transition-colors">
