export default function ContactSection() {
  return (
    <section id="contact" className="max-w-7xl mx-auto px-6 pb-24">
      ...
      <div className="grid sm:grid-cols-3 gap-4 max-w-2xl animate-fade-up">
        <a href="https://github.com/rajibmahata" target="_blank" rel="noopener noreferrer" className="card p-6 text-center group">
          <div className="w-12 h-12 rounded-xl bg-white/[0.04] flex items-center justify-center mx-auto mb-3 group-hover:bg-white/[0.08] transition-colors">
          ...
          <p className="text-xs text-[var(--text-muted)]">@rajibmahata</p>
        </a>

        <a href="https://linkedin.com/in/rajib-mahata" target="_blank" rel="noopener noreferrer" className="card p-6 text-center group">
          <div className="w-12 h-12 rounded-xl bg-white/[0.04] flex items-center justify-center mx-auto mb-3 group-hover:bg-white/[0.08] transition-colors">
          ...
          <p className="text-xs text-[var(--text-muted)]">@rajib-mahata</p>
        </a>

        <a href="mailto:contact@rajiblabs.com" className="card p-6 text-center group">
          <div className="w-12 h-12 rounded-xl bg-white/[0.04] flex items-center justify-center mx-auto mb-3 group-hover:bg-white/[0.08] transition-colors">
          ...
          <p className="text-xs text-[var(--text-muted)]">contact@rajiblabs.com</p>
        </a>
      </div>
    </section>
  );
