...
export const projects: ProjectDetail[] = [
  ...
  // ─── ENTERPRISE PROJECTS (Career) ──────────────────
  {
    ...
    role: 'Assistant Consultant — TCS at Meijer Inc. (USA)',
  ...
  },
  {
    ...
    role: 'Software Developer — Accenture at Cincinnati Bell (USA)',
